...
// #define ONENET_DEVICE_DYNAMIC_ENABLE 
  ...
  *
  */
#define ONENET_PRODUCT_ID "s6uqh1R74C"  //产品ID

#define ONENET_DEVICE_NAME "desktop_ir"  //设备名字
...
#define ONENET_PRODUCT_KEY "" //产品KEY
   ...
   *
   */
#define ONENET_DEVICE_KEY "ZGFRUVFzejczaEh0R2ljQVZwbEN3YUlMVXpQejlFYUk=" //设备KEY
